...
<div id="footer">
  ...
  <table width="743" height="93" border="1" align="center" cellpadding="7" cellspacing="0" bgcolor="#999999">
      ...
      <?php while ($pvote_array = mysqli_fetch_array($pvote_sql)) { ?>
      <tr>
        <td  style=""><?php echo $pvote_array['cand_name']; ?></td>
        <td  style=""><?php echo $pvote_array['party']; ?></td>
        <td  style=""><?php echo $pvote_array['votes']; ?> </td>
      </tr>
      <?php } ?>
  </table>
