<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $cand_query = mysqli_query($con,"SELECT * FROM governorship_candidates WHERE cand_name = '$cand_name' AND party = '$party'");
        ...
        if ($cand_rows != 0) {
            ...
            $create_query = mysqli_query($con,"INSERT INTO governorship_candidates(cand_name,party) VALUES('$cand_name','$party')");
            if ($create_query) {
