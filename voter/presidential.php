...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <?php if ($_SESSION['voter_pvoted'] == 0) { ?>
    ...
    <div id="footer">
      <p>&nbsp;</p>
      <form action="php/pvote.php" method="post" id="form1">
        <table width="671" border="0" align="center">
          ...
          <tr>
            <td height="151"><input type="radio" id="vote" name="vote" value="<?php echo $pres_array['pc_id'] ?>"></td>
            <td ><img src="<?= image($pres_array['party']); ?>"></td>
            <td><?php echo $pres_array['cand_name']; ?></td>
            <td><?php echo $pres_array['party']; ?></td>
          </tr>
          <?php } ?>
          <tr>
    ...
    <?php }elseif ($_SESSION['voter_pvoted'] == 1) { ?>
      <div id="content">
        <div id="left">
          <p align="right" style="text-align:center; color:#60B7DE;"> <a href="php/vlogout.php">LOGOUT</a></p>
        </div>
